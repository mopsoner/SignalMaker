...
class Settings(BaseSettings):
    ...
    momentum_live_enabled: bool = Field(default=False, alias="MOMENTUM_LIVE_ENABLED")
    momentum_live_mode: str = Field(default="margin", alias="MOMENTUM_LIVE_MODE")
    momentum_live_balance_confirm_attempts: int = Field(default=8, alias="MOMENTUM_LIVE_BALANCE_CONFIRM_ATTEMPTS")
    momentum_live_balance_confirm_sleep: float = Field(default=1.0, alias="MOMENTUM_LIVE_BALANCE_CONFIRM_SLEEP")
    momentum_live_interval_seconds: float = Field(default=60.0, alias="MOMENTUM_LIVE_INTERVAL_SECONDS")
    wyckoff_live_enabled: bool = Field(default=False, alias="WYCKOFF_LIVE_ENABLED")
    wyckoff_live_mode: str = Field(default="spot", alias="WYCKOFF_LIVE_MODE")
    wyckoff_live_interval_seconds: float = Field(default=60.0, alias="WYCKOFF_LIVE_INTERVAL_SECONDS")
    wyckoff_live_limit: int = Field(default=10, alias="WYCKOFF_LIVE_LIMIT")
    wyckoff_live_quantity: float = Field(default=1.0, alias="WYCKOFF_LIVE_QUANTITY")
    ...
    bot_wyckoff_paper_enabled: bool = Field(default=True, alias="BOT_WYCKOFF_PAPER_ENABLED")
    ...
    bot_wyckoff_paper_interval_sec: int = Field(default=30, alias="BOT_WYCKOFF_PAPER_INTERVAL_SEC")
    bot_scheduler_interval_sec: int = Field(default=30, alias="BOT_SCHEDULER_INTERVAL_SEC")
    bot_momentum_paper_interval_sec: int = Field(default=300, alias="BOT_MOMENTUM_PAPER_INTERVAL_SEC")
    momentum_paper_cadence_hours: int = Field(default=1, alias="MOMENTUM_PAPER_CADENCE_HOURS")
    bot_wyckoff_paper_limit: int = Field(default=10, alias="BOT_WYCKOFF_PAPER_LIMIT")
    bot_wyckoff_paper_quantity: float = Field(default=1.0, alias="BOT_WYCKOFF_PAPER_QUANTITY")
    bot_momentum_paper_enabled: bool = Field(default=True, alias="BOT_MOMENTUM_PAPER_ENABLED")

    momentum_paper_enabled: bool = Field(default=True, alias="MOMENTUM_PAPER_ENABLED")
    momentum_paper_starting_capital: float = Field(default=1000.0, alias="MOMENTUM_PAPER_STARTING_CAPITAL")
    momentum_paper_min_score: float = Field(default=0.0, alias="MOMENTUM_PAPER_MIN_SCORE")
