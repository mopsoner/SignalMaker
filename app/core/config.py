...
class Settings(BaseSettings):
    ...
    kraken_order_quote_amount: float = Field(default=20.0, alias="KRAKEN_ORDER_QUOTE_AMOUNT")
    ...
    kraken_margin_max_leverage: int = Field(default=2, alias="KRAKEN_MARGIN_MAX_LEVERAGE")
    ...
    momentum_execution_mode: str = Field(default="spot", alias="MOMENTUM_EXECUTION_MODE")
