...
from app.api.routes import admin_settings, assets, executor, fills, gateway, health, live_runs, market_data, orders, pipeline, positions, services, trade_candidates
...
api_router.include_router(gateway.router, prefix='/api/v1/gateway', tags=['gateway'])
