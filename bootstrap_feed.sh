...
BOOTSTRAP_REQUIRE_MARGIN_SELL="${BOOTSTRAP_REQUIRE_MARGIN_SELL:-${CANDLE_FEED_REQUIRE_MARGIN_SELL:-false}}"
...
BOOTSTRAP_MIN_4H="${BOOTSTRAP_MIN_4H:-4380}"
...
echo "Require margin sell: $BOOTSTRAP_REQUIRE_MARGIN_SELL"
...
BOOTSTRAP_REQUIRE_MARGIN_SELL="$BOOTSTRAP_REQUIRE_MARGIN_SELL" \
