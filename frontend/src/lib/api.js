...
export const api = {
  ...
  ibkrFeedStatus: () => request('/admin/market-data/ibkr-feed/status'),
  testIbkrFeedIngest: () => request('/admin/market-data/ibkr-feed/test-ingest', { method: 'POST' }),
  ibkrCandleSummary: () => request('/admin/market-data/ibkr-feed/candles/summary'),
