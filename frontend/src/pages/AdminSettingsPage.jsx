...
const EMPTY_SETTINGS = {
  ...
  strategy: { session_timezone_offset_hours: -4, signal_rsi_period: 14, signal_swing_window: 8, signal_equal_level_tolerance_pct: 0.0015, signal_overbought: 70, signal_oversold: 30, signal_price_near_extreme_pct: 0.0025, signal_session_confirm_filter_enabled: true, planner_min_score: 4, planner_min_rr: 0.8 },
...
export default function AdminSettingsPage() {
  ...
  async function loadSettings() {
    ...
    try {
      ...
      setInitialSettings({ ...EMPTY_SETTINGS, ...data })
