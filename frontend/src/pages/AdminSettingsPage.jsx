...
const EMPTY_SETTINGS = {
  ...
  binance: { binance_rest_base: '', binance_collector_enabled: false, binance_quote_assets: '', binance_symbol_status: '', binance_max_symbols: 25, binance_collect_max_workers: 4, binance_incremental_fetch_enabled: true, binance_incremental_min_1m: 3, binance_incremental_min_5m: 3, binance_incremental_min_15m: 3, binance_incremental_min_1h: 2, binance_incremental_min_4h: 2, binance_lookback_1m: 180, binance_lookback_5m: 180, binance_lookback_15m: 180, binance_lookback_1h: 180, binance_lookback_4h: 120 },
  ...
  return (
    <div className="page-stack">
      ...
      <section className="panel">
        <div style={gridStyle}>
          <Field label="Operator key"><input style={inputStyle} type="password" value={operatorKey} onChange={(e) => setOperatorKey(e.target.value)} placeholder="Optional backend operator key" /></Field>
        </div>
