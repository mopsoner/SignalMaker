...
export default function MarketDataAdminPage() {
  ...
  return <div className="page-stack">
    ...
    <AnalysisSection title="Configuration Momentum" description="Workflow Momentum partagé sur 15m, 1h et 4h. Les anciennes demandes daily/5m échouent avec un message de migration." defaultEngine="momentum" data={data} universes={universes} onMessage={setMessage} refresh={settingsQuery.refresh} />
