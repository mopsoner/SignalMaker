    ...
    <div className="app-shell">
      ...
      <main className="content" onClick={menuOpen ? closeMenu : undefined}>
        <Routes>
          ...
          <Route path="/momentum-candidates.html" element={<MomentumCandidatesPage />} />
          <Route path="/momentum-backtest" element={<MomentumBacktestV2Page />} />
          <Route path="/candidates" element={<CandidatesPage />} />
          <Route path="/candidates.html" element={<CandidatesPage />} />
          <Route path="/positions" element={<PositionsPage />} />
          <Route path="/positions.html" element={<PositionsPage />} />
          <Route path="/ops" element={<OpsPage />} />
          <Route path="/ops.html" element={<OpsPage />} />
          <Route path="/logs" element={<LogsPage />} />
          <Route path="/logs.html" element={<LogsPage />} />
          <Route path="/settings" element={<AdminSettingsPage />} />
          <Route path="/settings.html" element={<AdminSettingsPage />} />
        </Routes>
      </main>
    </div>
  )
